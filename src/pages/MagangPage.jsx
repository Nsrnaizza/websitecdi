        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1 text-center text-lg-start">
              <h1 style={{ fontSize: "1.90rem" }}>Program Kemitraan SMK</h1>
              <h4 className="fw-normal"style={{ fontSize: "1.3rem" }}>Mengambangkan tenaga didik sebagai calon tenaga kerja yang berkualitas</h4>
            </div>
            <div className="col-lg-6 order-1 order-lg-2 mb-3 mb-lg-0 text-center">
              <img className="h-auto mb-3 mb-lg-0 img-header" src="https://campusdigital.id/assets/images/illustration/min/6617.png" alt="banner" style={{ marginTop: "40px", maxHeight: "260px" }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <h1 style={{ fontSize: "1.90rem" }}>Tentang Kemitraan SMK</h1>
              <div className="mt-4">
