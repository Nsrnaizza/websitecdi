...
const GalleryComponent = () => {
  const dataGallery = [
    ...
    [
      ...
      { title: "Digital Creative Talenr Development Program", image: "src/assets/img/galery/2 8.jpg"},
    ],
    [
      ...
      { title: "Sertifikasi Operator Komputer Muda", image: "src/assets/img/galery/3 4.jpg"},
    ...
    [
      { title: "Pelatihan & Sertifikasi Digital Marketing", image: "src/assets/img/galery/4 1.jpg"},
        ...
        {dataGallery[currentPage].map((item, index) => (
          <Col md={3} key={index} className="mb-4">
            <Card className="h-100 shadow">
              <Card.Img variant="top" src={item.image} alt={item.title} className="img-fluid" />
