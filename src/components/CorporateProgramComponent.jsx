...
import { getRegularPrograms } from "../api/corporateApi";
...
const CorporateProgramComponent = () => {
  ...
  if (programs.length === 0 && !loading) {
    return (
      <div className="d-flex justify-content-center align-items-center" style={{ height: "100vh" }}>
        <div className="alert alert-info">Tidak ada program corporate yang tersedia saat ini.</div>
      </div>
    );
  }

  return (
    <div className="corporate-program" ref={containerRef}>
      {/* Animated Background */}
      <motion.div
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1 text-center text-lg-start">
              <h1>Program Corporate</h1>
              <h4 className="fw-normal">
                Daftar program pelatihan <span className="text-lowercase">Corporate</span>
                <br />
            ...
            {programs.map((program, index) => (
              <Col xs={12} sm={6} md={6} lg={3} key={program.id || index}>
                <Fade bottom delay={index * 50} triggerOnce>
                  ...
                  >
                    <a href={`corporate/${program.id}`} className="w-100 text-decoration-none h-100 d-block">
                      <div
