    ...
    <div className="page-program">
          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Peningkatan Kompetensi Digital Marketing (PKDM)</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Peningkatan Kompetensi Digital Marketing (PKDM).</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Peningkatan Kompetensi Digital Marketing (PKDM)?</span>
              </h2>
              <p className="lead text-muted">Pelatihan PKDM akan memberikan pemahaman mendalam tentang berbagai aspek digital marketing.</p>
            </div>
          </div>

          <div className="row g-4">
            {[
              "Perkembangan Industri dan pemasaran digital yang pesat menjadi semakin penting bagi bisnis",
              "Memberikan pengetahuan mendalam tentang berbagai aspek digital marketing",
              "Banyaknya update dan cara beradaptasi yang berubah",
            ].map((item, index) => (
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="text-center mb-5">
                <h2 className="fw-bold mb-3">
                  Manfaat Pelatihan <span className="text-danger">Peningkatan Kompetensi Digital Marketing (PKDM)</span>
                </h2>
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      <p className="mb-4">Program pelatihan dan pembelajaran praktis pemasaran digital. Anda akan belajar bagaimana merencanakan strategi penjualan hingga melakukan penjualan secara daring.</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      ...
                      <ul className="list-unstyled">
                        {["Membantu memahami trend up to date.", "Dapat meningkatkan peluang karir dan menjadi kompetitif di pasar tenaga kerja.", "Membantu mengidentifikasi peluang dan meningkatkan potensi keuntungan."].map(
                          (item, index) => (
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-3">
              Materi Pelatihan <span className="text-danger">Peningkatan Kompetensi Digital Marketing (PKDM)</span>
            </h2>
            <p className="lead text-muted">Kurikulum lengkap untuk menjadi profesional di bidang digital marketing</p>
          </div>

          <div className="row g-4">
            {[
              { title: "Product Analytics", content: "Memahami Dan Mengukur Kinerja Produk." },
              { title: "Trend Research", content: "Menganalisis Tren Dan Perkembangan Terkini." },
              { title: "Data & Analitycs", content: "Memahami Dan Menerapkan Konsep, Teknik, Dan Alat Alat Untuk Menganalisis Untuk Medapatkan Wawasan Bisnis." },
              { title: "Content Digital", content: "Memahami Strategi, Teknik, Dan Praktik Untuk Mengelola Konten Digital Yang Efektif." },
              { title: "Facebook & Instagram Ads", content: "Fitur Untuk Beriklan Yang Disediakan Suatu Platform." },
              { title: "Google Ads", content: "Mempromosikan Bisnis Melalui Iklan Di Berbagai Situs Dan Aplikasi" },
              { title: "SEO", content: "Strategi Untuk Meningkatkan Peringkat Situs Web Dalam Hasil Pencarian." },
              { title: "Web Marketing", content: "Membahas Strategi Dan Tenik Pemasaran Secara Online Untuk Promosi" },
              { title: "Marketplace Startegy", content: "Rencana Untuk Membangun Dan Mengembangkan Bisnis Di Marketplace" },
              { title: "Google My Business", content: "Mengelola Bisnis Secara Online" },
            ].map((item, index) => (
              <div className="col-md-6 col-lg-4" key={index}>
                <motion.div className="card border-0 shadow-sm h-100" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1, duration: 0.5 }} viewport={{ once: true }}>
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Peningkatan Kompetensi Digital Marketing (PKDM)</span>
          </h3>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Peningkatan Kompetensi Digital Marketing (PKDM).</p>
