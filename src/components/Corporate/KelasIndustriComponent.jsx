    ...
    <div className="page-program">
      ...
      <div className="hero-section2 d-flex align-items-center">
        <div className="container">
          <h1 className="mb-3 text-start">Kelas Industri Teknologi Digital</h1>
          ...
          <nav className="mt-2">
            <ol className="breadcrumb py-2 px-3 rounded-5 text-dark text">
              ...
              <li>
                <span> / </span>
                Kelas Industri Teknologi Digital
              </li>
            </ol>
          </nav>
        </div>
          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Kelas Industri Teknologi Digital</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Kelas Industri Teknologi Digital.</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Kelas Industri Teknologi Digital?</span>
              </h2>
              <p className="lead text-muted">Mengikuti program ini memberikan keuntungan besar di dunia teknologi digital.</p>
            </div>
          </div>

          <div className="row g-4">
            {["Dirancang untuk meningkatkan keterampilan teknologi digital", "Industri teknologi digital terus berkembang", "Permintaan orang dengan keterampilan terus meningkat"].map((item, index) => (
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="text-center mb-5">
                <h2 className="fw-bold mb-3">
                  Manfaat Pelatihan <span className="text-danger">Kelas Industri Teknologi Digital</span>
                </h2>
                <p className="lead text-muted">Keunggulan yang Anda dapatkan dari pelatihan ini</p>
              </div>
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      <p className="mb-4">Mengikuti program ini akan memberikan Anda keunggulan kompetitif di pasar kerja yang kompetitif dan memberi Anda keterampilan dan pengetahuan yang relevan dalam teknologi digital.</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      ...
                      <ul className="list-unstyled">
                        {["Peningkatan keterampilan teknologi digital", "Memperluas wawasan tentang industri", "Update perubahan teknologi"].map((item, index) => (
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-3">
              Materi Pelatihan <span className="text-danger">Kelas Industri Teknologi Digital</span>
            </h2>
            <p className="lead text-muted">Kurikulum lengkap untuk menjadi profesional di bidang teknologi digital</p>
          </div>

          <div className="row g-4">
            {[
              { title: "Komputer Perkantoran", content: "Mendukung Tugas Administratif Dan Operasional Lingkungan Kantor." },
              ...
              { title: "Multimedia", content: "Membuat Animasi, Video Dll." },
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Kelas Industri Teknologi Digital</span>
          </h3>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Kelas Industri Teknologi Digital.</p>
...
export default KelasIndustriComponent;
