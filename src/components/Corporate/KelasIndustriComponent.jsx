  ...
  return (
    <div className="page-program">
      ...
      <div className="container training-info bg-light-puple text-center p-4 rounded shadow mt-5">
        ...
        <h3>
          Sertifikasi <b>Kelas Industri Teknologi Digital</b> BNSP
        </h3>
        <img className="bnsp-logo" src="https://campusdigital.id/assets/images/bnsp/logo_bnsp.png" alt="BNSP-LOGO" />
        <p>Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Kelas Industri Teknologi Digital.</p>
      ...
      <div className="raeseon-container">
        <div className="reasons-section">
          <h3>
            Mengapa Harus Menguasai <span className="highlight">Kelas Industri Teknologi Digital?</span>
          </h3>
          <p>Mengikuti program Kelas Industri Teknologi Digital akan memberikan Anda keuntungan dalam memahami, menguasai, dan berkembang di dunia teknologi digital yang terus berkembang.</p>
          <ul className="checklist">
            <li>Dirancang untuk meningkatkan keterampilan teknologi digital</li>
            <li>Industri teknologi digital terus berkembang</li>
            <li>Permintaan orang dengan keterampilan terus meningkat</li>
          </ul>
        </div>
      </div>
      {/* Manfaat */}
      <div className="benefits-section">
        <h3>
          Manfaat Pelatihan <span className="highlight">Kelas Industri Teknologi Digital</span>
        </h3>
        <p>
          Mengikuti program Kelas Industri Teknologi Digital akan memberikan Anda keunggulan kompetitif di pasar kerja yang kompetitif dan memberi Anda keterampilan dan pengetahuan yang relevan dalam teknologi digital. Ini adalah investasi
          yang berharga untuk pengembangan karier Anda dalam era digital ini.
        </p>
        <ul className="checklist">
          <li>Peningkatan keterampilan tekonologi digital.</li>
          <li>Memeperluas Wawasan tentang industry.</li>
          <li>Update perubahan teknologi.</li>
        </ul>
      </div>
      {/* Materi Pelatihan */}
          ...
          <div className="row m-md-3 m-sm-3">
            <div className="card title">
              <h3 className="mb-4 mt-3 text-center">
                Materi Pelatihan <span style={{ color: "red" }}>Kelas Industri Teknologi Digital</span>
              </h3>
              <div className="row p-lg-4 p-md-2 p-sm-1">
                {[
                  {
                    title: "Komputer Perkantoran",
                    content: "Mendukung Tugas Administratif Dan Operasional Lingkungan Kantor.",
                  },
                  {
                  ...
                  {
                    title: "Multimedia",
                    content: "Membuat Animasi, Video Dll.",
                  },
                  {
      ...
      <div className="pricing-section text-center">
        <h2>
          Berapa Biaya Investasi Pelatihan <span>Kelas Industri Teknologi Digital?</span>
        </h2>
