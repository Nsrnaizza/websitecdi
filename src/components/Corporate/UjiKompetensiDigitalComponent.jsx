          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Uji Kompetensi Teknologi Digital</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Uji Kompetensi Teknologi Digital.</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Uji Kompetensi Teknologi Digital?</span>
              </h2>
              <p className="lead text-muted">
                Mengikuti program uji kompetensi teknologi digital adalah langkah yang penting dalam mengukur kemampuan Anda, mendapatkan pengakuan resmi, dan meningkatkan peluang karier Anda dalam bidang teknologi digital.
              </p>
            </div>
          </div>

          <div className="row g-4">
            {["Mengukur keterampilan dan pengetahuan", "Validasi dan pengakuan", "Meningkatkan peluang karir", "Meningkatkan pengetahuan"].map((item, index) => (
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Uji Kompetensi Teknologi Digital</span>
          </h3>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Uji Kompetensi Teknologi Digital.</p>
