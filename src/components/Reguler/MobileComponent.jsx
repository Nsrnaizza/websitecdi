    ...
    <div className="page-program">
          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Mobile Programmer</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Mobile Programmer.</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Mobile Programmer?</span>
              </h2>
              <p className="lead text-muted">
                Menguasai keterampilan sebagai mobile programmer memberi Anda akses ke pasar yang berkembang pesat, peluang karir yang menjanjikan, dan potensi untuk menjadi bagian dari inovasi teknologi yang sedang berlangsung.
              </p>
            </div>
          </div>

          <div className="row g-4">
            {["Industri aplikasi mobile berkembang pesat.", "Permintaan tinggi di pasar kerja.", "Potensi Pendapatan yang menjanjikan.", "Dapat bekerja di berbagai industri."].map((item, index) => (
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="text-center mb-5">
                <h2 className="fw-bold mb-3">
                  Manfaat Pelatihan <span className="text-danger">Mobile Programmer</span>
                </h2>
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      <p className="mb-4">Program Pelatihan dan Pembelajaran praktis membuat aplikasi mobile. Anda akan belajar bagaimana merancang dan mengembangkan aplikasi mobile yang menarik dan fungsional.</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      ...
                      <ul className="list-unstyled">
                        {["Menguasai bahasa pemrograman mobile", "Mampu mengembangkan aplikasi mobile", "Dapat bekerja dalam tim."].map((item, index) => (
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-3">
              Materi Pelatihan <span className="text-danger">Mobile Programmer</span>
            </h2>
            <p className="lead text-muted">Kurikulum lengkap untuk menjadi Mobile Programmer profesional</p>
          </div>

          <div className="row g-4">
            {[
              { title: "Introduction", content: "Memperkenalkan Software Yang Akan Digunakan Untuk Menjadi Mobile Programmer." },
              { title: "Setting Up On Android", content: "Menginstall Tools Yang Dibutuhkan Dalam Pengembangan." },
              { title: "User Interface", content: "Membuat Tampilan Visual Yang Dapat Berinteraksi Dengan Sistem." },
              { title: "Networking", content: "Interaksi Antara Perangkat Komputer Untuk Bertukar Data, Berbagi Sumber Daya, Atau Berkomunikasi." },
              { title: "Multimedia", content: "Memahami Dan Menerapkan Elemen Teknik Yang Digunakan." },
              { title: "Application Components", content: "UI, Logika, Penyimpanan Data, Komunikasi Jaringan, Dll." },
              { title: "Data Storage Methods", content: "Metode Metode Penyimpanan Data Yang Digunakan Dalam Pengembangan Aplikasi." },
              { title: "Location Based Service", content: "Konsep, Teknologi, Dan Aplikasi Yang Memanfaatkan Lokasi Untuk Memberikan Layanan Kepada Pengguna." },
              { title: "Debugging And Testing", content: "Memastikan Kualitas, Dan Kinerja Dari Sebuah Aplikasi" },
              { title: "Publishing", content: "Mengunggah Aplikasi Ke Platform Atau Aplikasi" },
            ].map((item, index) => (
              <div className="col-md-6 col-lg-4" key={index}>
                <motion.div className="card border-0 shadow-sm h-100" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1, duration: 0.5 }} viewport={{ once: true }}>
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Mobile Programmer</span>
          </h3>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Mobile Programmer.</p>
