  ...
  return (
    <div className="page-program">
      ...
      <div className="container training-info bg-light-puple text-center p-4 rounded shadow mt-5">
        ...
        <h3>
          Sertifikasi <b>Web Designer</b> BNSP
        </h3>
        <img className="bnsp-logo" src="https://campusdigital.id/assets/images/bnsp/logo_bnsp.png" alt="BNSP-LOGO" />
        <p>Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Web Designer.</p>
      ...
      <div className="raeseon-container">
        <div className="reasons-section">
          <h3>
            Mengapa Harus Menguasai <span className="highlight">Web Designer?</span>
          </h3>
          <ul className="checklist">
            <li>Permintaan untuk digitalisasi sebuah usaha / perusahaan sangat banyak</li>
            <li>Dapat dilakukan secara freelance atau Work From Home</li>
            <li>Perancangan yang menarik dapat meningkatkan kepeminatan pengunjung</li>
            <li>Penampilan adalah segalanya</li>
            <li>Website menjadi good looking</li>
          </ul>
        </div>
      </div>
      {/* Manfaat */}
      <div className="benefits-section">
        <h3>
          Manfaat Pelatihan <span className="highlight">Web Designer</span>
        </h3>

        <p className="description">
          Program Pelatihan dan Pembelajaran praktis membuat website. Anda akan belajar bagaimana merancang dan mendesain website yang menarik dan mendatangkan pengunjung. Web designer adalah seorang profesional yang bertanggung jawab untuk
          merancang dan menciptakan tampilan visual serta tata letak halaman-halaman website. Mereka menggabungkan elemen-elemen desain grafis, tipografi, warna, dan gambar untuk menciptakan pengalaman visual yang menarik dan fungsional
          bagi pengguna website seperti :
        </p>
        <ul className="checklist">
          <li> Perancangan tata letak halaman</li>
          <li> Pemilihan warna dan tipografi</li>
          <li> Desain website yang responsif untuk segala ukuran layar</li>
        </ul>
      </div>
      {/* Materi Pelatihan */}
          ...
          <div className="row m-md-3 m-sm-3">
            <div className="card title">
              <h3 className="mb-4 mt-3 text-center">
                Materi Pelatihan <span style={{ color: "red" }}>Web Designer</span>
              </h3>
      ...
      <div className="pricing-section text-center">
        <h2>
          Berapa Biaya Investasi Pelatihan <span>Web Designer ?</span>
        </h2>
