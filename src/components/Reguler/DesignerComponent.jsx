...
const DesignerComponent = () => {
  ...
  // Data untuk materi pelatihan
  const trainingMaterials = [
    {
      title: "HTML & CSS",
      content: "Pembelajaran Dasar Untuk Website",
    },
    {
      title: "Wordpress",
      content: "Pembuatan Website Yang Simple Dengan Drag & Drop",
    },
    {
      title: "Javascript",
      content: "Belajar Tentang Interaksi Antara Website Dengan Pengunjung",
    },
    {
      title: "Jquery",
      content: "Pengembangan Lebih Lanjut Dan Kompleks Dari Javascript",
    },
    {
      title: "Bootstrap",
      content: "Pengembangan Lebih Lanjut Untuk Memudahkan Penggunaan CSS Dalam Code",
    },
    {
      title: "User Interface (UI)",
      content: "Desain Tampilan Untuk Website",
    },
    {
      title: "User Experience (UX)",
      content: "Belajar Tentang Pengalaman Pengguna Yang Umum Digunakan Seperti Pemilihan Warna Dan Letak",
    },
    {
      title: "Photoshop",
      content: "Belajar Tentang Penggunaan Dasar Untuk Mendesain Website",
    },
    {
      title: "React JS",
      content: "Pengembangan Lebih Lanjut Tentang Jquery Dan Kompleks",
    },
  ];
    ...
    <div className="page-program">
      ...
      <div className="hero-section2 d-flex align-items-center">
        <div className="container">
          <h1 className="mb-3 text-start">Web Designer</h1>
          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Web Designer</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Web Designer.</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Web Designer?</span>
              </h2>
          ...
          <div className="row g-4">
            {[
              "Permintaan untuk digitalisasi sebuah usaha/perusahaan sangat banyak",
              "Dapat dilakukan secara freelance atau Work From Home",
              "Perancangan yang menarik dapat meningkatkan kepeminatan pengunjung",
              "Penampilan adalah segalanya",
              "Website menjadi good looking",
            ].map((item, index) => (
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="text-center mb-5">
                <h2 className="fw-bold mb-3">
                  Manfaat Pelatihan <span className="text-danger">Web Designer</span>
                </h2>
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="card border-0 h-100 shadow-sm">
                    <div className=" p-4">
                      <p className="mb-4">
                        Program Pelatihan dan Pembelajaran praktis membuat website. Anda akan belajar bagaimana merancang dan mendesain website yang menarik dan mendatangkan pengunjung. Web designer adalah seorang profesional yang
                        bertanggung jawab untuk merancang dan menciptakan tampilan visual serta tata letak halaman-halaman website.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card border-0 h-100 shadow-sm">
                    <div className=" p-4">
                      ...
                      <ul className="list-unstyled">
                        {["Perancangan tata letak halaman", "Pemilihan warna dan tipografi", "Desain website yang responsif untuk segala ukuran layar"].map((item, index) => (
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-3">
              Materi Pelatihan <span className="text-danger">Web Designer</span>
            </h2>
            <p className="lead text-muted">Kurikulum lengkap untuk menjadi Web Designer profesional</p>
          </div>
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Web Designer</span>
          </h3>
          ...
          <div className="d-flex justify-content-center align-items-baseline mb-2">
            ...
            <span className="badge bg-success bg-opacity-10 text-success px-2 py-1 small">Hemat Rp 100.000</span>
          </div>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Web Designer.</p>
