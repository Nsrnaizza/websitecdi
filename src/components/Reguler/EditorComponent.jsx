    ...
    <div className="page-program">
      ...
      <div className="hero-section2 d-flex align-items-center">
        <div className="container">
          <h1 className="mb-3 text-start">Video Editor</h1>
          ...
          <motion.div className="card border-0 shadow-sm p-4 p-md-5 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <div className="row justify-content-center">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-danger">Video Editor</span> BNSP
                </h3>
                ...
                <p className="lead mb-4">Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Video Editor.</p>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center mb-5">
              <h2 className="fw-bold mb-3">
                Mengapa Harus Menguasai <span className="text-danger">Video Editor?</span>
              </h2>
          ...
          <div className="row g-4">
            {["Meningkatkan kreativitas", "Bebas berekspresi sesuai imajinasi", "Dapat mengontrol alur cerita", "Mengasah kemampuan komunikasi visual", "Kebutuhan industri yang tidak sedikit terutama di bidang konten kreator"].map(
              (item, index) => (
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="text-center mb-5">
                <h2 className="fw-bold mb-3">
                  Manfaat Pelatihan <span className="text-danger">Video Editor</span>
                </h2>
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      <p className="mb-4">
                        Pelatihan video editor membuka pintu bagi peluang karir yang menarik dan mengembangkan keterampilan kreatif dan teknis Anda. Ini memungkinkan Anda untuk menghasilkan konten video yang menarik, profesional, dan
                        berdampak.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="card border-0 h-100 shadow-sm">
                    <div className="p-4">
                      ...
                      <ul className="list-unstyled">
                        {[
                          "Meningkatkan kreativitas dan pengembangan gaya",
                          "Memperoleh pemahaman dalam editing video",
                          "Membuat alur naratif yang baik",
                          "Meningkatnya pemahaman tentang penggunaan aplikasi Adobe Premiere dan Adobe After Effect",
                        ].map((item, index) => (
      ...
      <section className="py-5">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="fw-bold mb-3">
              Materi Pelatihan <span className="text-danger">Video Editor</span>
            </h2>
            <p className="lead text-muted">Kurikulum lengkap untuk menjadi Video Editor profesional</p>
          </div>
            ...
            {[
              {
                ...
                content: "Mempelajari Tentang Dasar Penggunaan Tools Adobe Premiere Dalam Pembuatan Video.",
              },
              {
                title: "Adobe After Effect",
                content: "Mempelajari Pembuatan Effect-effect Pada Aplikasi Adobe After Effect.",
              },
            ].map((item, index) => (
              <div className="col-md-6 col-lg-4" key={index}>
                <motion.div className="card border-0 shadow-sm h-100" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1, duration: 0.5 }} viewport={{ once: true }}>
      ...
      <section className="py-4 bg-light border-top border-bottom">
        <div className="container text-center">
          <h3 className="fw-bold mb-3">
            Biaya Pelatihan <span className="text-danger">Video Editor</span>
          </h3>
          ...
          <div className="d-flex justify-content-center align-items-baseline mb-2">
            ...
            <span className="badge bg-success bg-opacity-10 text-success px-2 py-1 small">Hemat Rp 250.000</span>
          </div>
                ...
                <div className="p-3 p-md-4">
                  <div className="row align-items-center">
                    <div className="col-lg-6 mb-4 mb-lg-0 px-4">
                      ...
                      <p className="text-muted small mb-3">Silakan isi formulir untuk mendaftar pelatihan Video Editor.</p>
