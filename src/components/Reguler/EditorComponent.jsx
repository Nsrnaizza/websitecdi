  ...
  return (
    <div className="page-program">
      ...
      <div className="container training-info bg-light-puple text-center p-4 rounded shadow mt-5">
        ...
        <h3>
          Sertifikasi <b>Video Editor</b> BNSP
        </h3>
        <img className="bnsp-logo" src="https://campusdigital.id/assets/images/bnsp/logo_bnsp.png" alt="BNSP-LOGO" />
        <p>Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Video Editor.</p>
      ...
      <div className="raeseon-container">
        <div className="reasons-section">
          <h3>
            Mengapa Harus Menguasai <span className="highlight">Video Editor?</span>
          </h3>
          <ul className="checklist">
            <li>Meningkatkan kreativitas</li>
            <li>Bebas berekspresi sesuai imajinasi</li>
            <li>Dapat mengontrol alur cerita</li>
            <li>Mengasah kemampuan komunikasi visual</li>
            <li>Kebutuhan industri yang tidak sedikit terutama dibidang konten kreator</li>
          </ul>
        </div>
      </div>
      {/* Manfaat */}
      <div className="benefits-section">
        ...
        <p className="description">
          Pelatihan video editor membuka pintu bagi peluang karir yang menarik dan mengembangkan keterampilan kreatif dan teknis Anda. Ini memungkinkan Anda untuk menghasilkan konten video yang menarik, profesional, dan berdampak.
        </p>
        <ul className="checklist">
          <li> Meningkatkan kreativitas dan pengembangan gaya</li>
          <li> Memperoleh pemahaman dalam editing video</li>
          <li> Membuat alur naratif yang baik</li>
          <li> Meningkatnya pemahaman tentang penggunaan aplikasi Adobe Premiere dan Adobe After Effect</li>
        </ul>
      </div>
      {/* Materi Pelatihan */}
