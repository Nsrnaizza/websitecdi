    ...
    <div className="page-program">
      ...
      <div className="hero-section2 d-flex align-items-center" >
        <div className="container">
          <h1 className="mb-3 text-start">Software Development And Data Science</h1>
          <div className="flex">
          ...
          >
            <div className="row justify-content-center ">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-">Software Development And Data Science</span> BNSP
                </h3>
                <img 
                ...
                Progam Pembelajaran Online Via Zoom Meet atau Offline Tatap Muka Untuk Anda Yang Membutuhkan Sertifikat BNSP di Bidang  Software Development And Data Science
                </p>
                <motion.a 
    ...
    <div className="row justify-content-center">
      <div className="col-lg-8 text-center mb-2">
        <h2 className="fw-bold mb-4 fs-7">
          Manfaat Pelatihan<span className="text-danger fs-7"> Software Development And Data Science</span>
        </h2>
        <p className="">
          Skema Sertifikasi:
        </p>
