  ...
  return (
    <div className="page-program">
      ...
      <div className="container training-info bg-light-puple text-center p-4 rounded shadow mt-5">
        ...
        <h3>
          Sertifikasi <b>Software Development And Data Science</b> BNSP
        </h3>
        <img className="bnsp-logo" src="https://campusdigital.id/assets/images/bnsp/logo_bnsp.png" alt="BNSP-LOGO" />
        <p>Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Software Development And Data Science.</p>
      ...
      <div className="benefits-section">
        <h3>
          Manfaat Pelatihan <span>Software Development And Data Science</span>
        </h3>
        <ul>
