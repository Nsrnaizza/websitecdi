          ...
          >
            <div className="row justify-content-center ">
              <div className="col-md-8">
                ...
                <h3 className="mb-4">
                  Sertifikasi <span className="fw-bold text-">Project Management And Quality</span> BNSP
                </h3>
                <img 
                ...
                Progam Pembelajaran Online Via Zoom Meet atau Offline Tatap Muka Untuk Anda Yang Membutuhkan Sertifikat BNSP di Bidang  Project Management And Quality
                </p>
                <motion.a 
