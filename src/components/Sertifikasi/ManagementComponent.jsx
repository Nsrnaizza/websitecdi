    ...
    <div className="page-program">
      ...
      <div className="hero-section2 d-flex align-items-center" >
        <div className="container">
          <h1 className="mb-3 text-start">Project Management And Quality</h1>
          <div className="flex">
      ...
      <div className="container training-info bg-light-puple text-center p-4 rounded shadow mt-5">
        ...
        <h3>
          Sertifikasi <b>Project Management And Quality</b> BNSP
        </h3>
        <img className="bnsp-logo" src="https://campusdigital.id/assets/images/bnsp/logo_bnsp.png" alt="BNSP-LOGO" />
        <p>Program pembelajaran online via Zoom atau offline tatap muka untuk Anda yang membutuhkan sertifikat BNSP di bidang Project Management And Quality.</p>
      ...
      <div className="benefits-section">
        <h3>
          Manfaat Pelatihan <span>Project Management And Quality</span>
        </h3>
        <ul>
          <li>Skema Sertifikasi:</li>

          <li>1. ICT Project Manager</li>
          <li>2. Management Project Specialyst*</li>
          <li>3. IT Quality Assurance</li>
          <li>4. IT Auditor</li>
          <li>5. Chief information officer</li>
          <li>6. Scrum Master* </li>
          <li>7. Scrum Fundamental*</li>
          <li>8. Deputy Manager ICT Project Management</li>
        </ul>
      </div>
